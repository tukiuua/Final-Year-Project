                ...
                <div class="panel-body">
                    ...
                    <h1> Hello Standard User </h1>
                        <div id="dashboardButtons">
                            <button class="dashboardButton"><a href="viewAccomodation">View Accommodation<br><br><img src="{{URL::asset('/images/dashboard_icons/accomm_icon.png')}}" alt="viewAccomodation" height="90px" width="90px"></a></button>
                            ...
                            <button class="dashboardButton"><a href="viewApplication">View application status<br><br><img src="{{URL::asset('/images/dashboard_icons/status_icon.png')}}" alt="viewApplication" height="90px" width="90px"></a></button>
                            ...
                            <button class="dashboardButton"><a href="rateAccomodation">Rate an accommodation<br><br><img src="{{URL::asset('/images/dashboard_icons/rate_icon.png')}}" alt="rateAccomodation" height="90px" width="90px"></a></button>
